...
def main():
    ...
    try:
        ...
        md_content += (
            "This report ranks the modules by their interconnectedness, helping to identify core "
            "'Hubs' (highly imported), heavy 'Consumers' (importing many things), and isolated "
            "code.\n\n"
        )
        ...
        md_content += "\n## Entry Points\n"
        md_content += (
            "Known entry points and runner scripts that are not imported by other internal "
            "modules.\n\n"
        )
        md_content += "| Module |\n|---|\n"
        ...
        md_content += (
            "Internal modules that are NEVER imported by anything else in the package. These are "
            "prime candidates for deletion or iceboxing (unless they are top-level entry point "
            "scripts).\n\n"
        )
        md_content += "| Module |\n|---|\n"
