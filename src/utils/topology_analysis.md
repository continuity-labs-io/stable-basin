...
This report ranks the modules by their interconnectedness, helping to identify
core 'Hubs' (highly imported), heavy 'Consumers' (importing many things), and
isolated code.
...
Internal modules that are NEVER imported by anything else in the package. These
are prime candidates for deletion or iceboxing (unless they are top-level entry
point scripts).
