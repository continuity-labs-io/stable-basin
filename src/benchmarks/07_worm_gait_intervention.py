...
def setup_experiment(config):
    ...
    micro = MarkovBlanketObserver(
        ...
        c_micro["d_active"],
        c_micro["d_external"],
        ebm_hidden_size=c_micro["ebm_hidden_size"],
        ebm_depth=c_micro["ebm_depth"],
        n_steps=1,
        temperature=c_micro["temperature"],
        key=k1,
    )
    ...
    macro = MarkovBlanketObserver(
        ...
        c_macro["d_active"],
        c_macro["d_external"],
        ebm_hidden_size=c_macro["ebm_hidden_size"],
        ebm_depth=c_macro["ebm_depth"],
        n_steps=1,
        temperature=c_macro["temperature"],
        key=k2,
    )
    ...
    micro = eqx.tree_at(
        ...
        PrecisionWeightedEBM(
            d_state=d_micro_full,
            hidden_size=c_micro["ebm_hidden_size"],
            depth=c_micro["ebm_depth"],
            key=k3,
        ),
    )
    macro = eqx.tree_at(
        ...
        macro,
        PrecisionWeightedEBM(
            d_state=d_macro_full,
            hidden_size=c_macro["ebm_hidden_size"],
            depth=c_macro["ebm_depth"],
            key=k3,
        ),
    )
    ...
    try:
        ...
        logger.warning(
            f"Trained model not found at {model_path}! Proceeding with random initialization."
        )
