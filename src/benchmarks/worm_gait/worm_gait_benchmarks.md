...
## 05 & 06: Visualization & Sweeps
- **Animation (`05_animate_worm_gait.py`)**: Renders a visual GIF animation comparing the raw physical young and old worm gait data.
- **Lambda Sweep (`06_worm_gait_lambda_sweep.py`)**: Performs a dose-response sweep across various values of the precision injection parameter $\lambda$. It systematically calculates the resulting mean Hessian trace and Cohen's $d$ effect sizes for each discrete intervention intensity.

## 07: Pharmacological Translation (`07_pharmacological_translation.py`)
...
## 08: Reviewer 2 Baseline - SSM (`08_worm_gait_aging_ssm.py`)
...
## 09: Reviewer 2 Baseline - Transformer (`09_worm_gait_aging_transformer.py`)
