...
def main():
    ...
    print(f"Phase B | Div: {div_B[-1]:.4f} | Trace: {trace_B:.4f}")
    print(f"Phase B | Rank: {rank_B} | Nullity: {nullity_B}")
    print(f"Phase C | Div: {div_C[-1]:.4f} | Trace: {trace_C:.4f}")
    print(f"Phase C | Rank: {rank_C} | Nullity: {nullity_C}")
    print("---------------------")
