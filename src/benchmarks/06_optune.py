...
def objective(trial, train_young_loader, eval_young_loader, eval_old_loader, base_config):
    ...
    macro_hidden_size = trial.suggest_categorical('observer.macro.ebm_hidden_size', [16, 32, 64, 128])
...
def main():
    ...
    study.optimize(
        lambda trial: objective(trial, train_young_loader, eval_young_loader, eval_old_loader, base_config), 
