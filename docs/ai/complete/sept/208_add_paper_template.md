Please create a new file named `paper/paper_tools/imrad_structure.md`. This file will serve as the master structural blueprint and standard operating procedure for all future computational biology papers generated in this repository. 

Populate the file exactly with the following markdown content:
