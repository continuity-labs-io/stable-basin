Create a new pytest file `tests/test_physics_invariants.py` to write synthetic unit tests that mathematically prove our core physics operations. I need two tests:
