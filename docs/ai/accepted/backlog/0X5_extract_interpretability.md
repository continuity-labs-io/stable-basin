...
3. Remove all hardcoded biological feature names (e.g., "PC", "RNA_TP53") from the diagnostic engine. Allow the user to optionally pass a list of `feature_names` during initialization for the causal trace report.
