...
Phase 2: Adhesion (T=1000 to 2000): The cell sticks. Inject 'Critical Slowing
Down'—variance slowly rises, and Lag-1 Autocorrelation (AR1) approaches 1.0.

Phase 3: The Breach (T=2000 to 3000): Massive variance explosion. The L2 norm of
...
Bottom: KSM Curve dropping below 0.85 in Phase 2.

4 Plot a red dashed line where the KSM triggers the 'Early Warning Radar',
proving we detect the metastasis before the physical breach in Phase 3.
